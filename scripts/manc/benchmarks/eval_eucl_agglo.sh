bsub -J "AE Eval Euclidean" -n 4 -gpu "num=1" -q gpu_l4 -o logs/bold_color_paper_manc_eucl_agglo_test.log python -m benchmarks.affinity.euclidean  \
    ...
    --output_dir /nrs/turaga/jakob/implicit-neurons/ckpt/ae/bold_color_paper_manc_eucl_agglo_test \
