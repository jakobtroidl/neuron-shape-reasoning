bsub -J "AE Eval (Topology)" -n 8 -gpu "num=1" -q gpu_h100 -o logs/paper_flywire_ours_t_0_1.log python eval_topology.py \
    --model ae_d1024_m512 \
    ...
    --output_dir /nrs/turaga/jakob/implicit-neurons/ckpt/ae/paper_flywire_ours_t_0_1 \
