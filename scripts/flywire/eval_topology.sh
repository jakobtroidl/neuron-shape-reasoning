bsub -J "AE Eval (Topology)" -n 8 -gpu "num=1" -q gpu_h200 -o logs/neurips_rebuttal_more_metrics.log python eval_affinity.py \
    --model ae_d1024_m512 \
    ...
    --output_dir /nrs/turaga/jakob/implicit-neurons/ckpt/ae/neurips_rebuttal_more_metrics \
