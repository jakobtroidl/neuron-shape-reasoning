from util.datasets import build_flywire_dataset, build_affinity_dataset

from util.misc import NativeScalerWithGradNormCount as NativeScaler
from engine_ae_topology import train_one_epoch
...
def main(args):
    ...
    model = models_topology.__dict__[args.model](depth=args.depth)
